---
description: Merge development branch to main branch (general)
---
...
If the branch is `development` then proceed the operation otherwise stop here. 

⚠️ **If you have uncommitted changes then stop here. Tell user you should commit first** 
