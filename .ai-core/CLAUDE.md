...
We should always update `.ai-core/project-resources/{project-name}/docs/` docs after we implement certain feature, to make sure it fully reflect the up to date information

Before you plan any implementation, always read the `.ai-core/project-resources/{project-name}/docs/README.md` first to get context
