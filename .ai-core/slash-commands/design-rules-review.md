---
description: design rule review
---
...
**Note:**
- Your task is to only review design rules. 
- Don't review development rule.


UI design rule for this project: In this directory you will find design rule `.ai-core/project-resources/{project-name}/project-design-and-development-rules/`
