# Product Requirements Document: Shourov Rahman Portfolio Website

## Product Overview

A conversion-focused portfolio website for Shourov Rahman, showcasing ecommerce store design & development, paid advertising, and tracking & analytics services. The website will serve as the primary acquisition channel for targeting revenue-generating ecommerce brands, marketing agencies, early-stage founders, and brick & mortar businesses transitioning to DTC.

The portfolio will demonstrate expertise in Shopify/WooCommerce development, landing page design (GemPages/Replo), Facebook/Google Ads management, and conversion tracking (Meta Pixel, CAPI, GA4).

---

## Business Objectives

1. Generate qualified inbound leads from 4 target ICPs (ecommerce brands, agencies, early-stage founders, B&M businesses)
2. Establish credibility and expertise in ecommerce conversion optimization and paid advertising
3. Differentiate from competitors through case studies, social proof, and clear service positioning
4. Achieve 2-3% conversion rate from visitor to contact form submission within 6 months
5. Support scalable client acquisition for project-based ($800-$12,000) and retainer engagements ($1,500-$8,000/month)
...
- **Emotional Triggers:** Fear of being left behind, desire to modernize
...
4. **Business Results:** Focus on CVR, ROAS, MER, and revenue growth metrics
...
- **Trust indicators:** Years active, number of brands served, key metrics
...
- Event tracking & custom conversions
...
- Before/after screenshots or metrics dashboards
...
- Why clients choose to work with you
...
- **404 Error Page**
- **Thank You Page (`/thank-you`)** - Post-form submission
...
5. Click CTA → Fill contact form → Submit
...
4. Scroll to FAQ → Find agency partnership information
5. Click CTA → Fill contact form with "Agency Partnership" note
...
4. Navigate to FAQ → Check pricing and timeline
5. Click CTA → Fill contact form → Submit
6. Receive confirmation with clear next steps
...
2. **Email Marketing**
   ...
   - Automatic lead list segmentation
   - Welcome email automation

3. **Calendar Booking**
   - Calendly or Cal.com
   - Direct integration in CTA buttons
   - Timezone auto-detection

4. **CRM (Optional)**
   - HubSpot, Pipedrive, or Google Sheets
...
2. **Video Hosting**
   - Vimeo or YouTube for case study videos
   - Lazy loading for performance

3. **Social Proof Widget**
   - Trustpilot or Feefo integration
...
- **Mobile-First Responsive:** Fully functional on all devices (320px - 2560px)
...
- Facebook Ads manager for ecommerce
...
- Blog posts (if included) targeting long-tail keywords
...
- External link clicks (social media, case studies)
...
- **Domain:** ~$15/year (.com)
- **Third-Party Tools:** $0-$50/month (Mailchimp/Calendly free tiers initially)
...
- **Week 6:** QA, SEO audit, soft launch
- **Week 7:** Public launch and promotion

**Total Timeline:** 6-7 weeks to MVP launch
...
- GA4 and Meta Pixel integration
...
- A/B test variations of CTAs and headlines
...
- [ ] 6-8 testimonials collected with permission
...
- [ ] Forms tested and receiving notifications
- [ ] GA4 tracking code installed and verified
- [ ] Meta Pixel installed and conversion events configured
...
- [ ] Schema markup implemented (Organization, Person, Service)
...
- [ ] GDPR compliance reviewed (for EU visitors)
...
- [ ] Announce launch on LinkedIn, social media
...
- [ ] Test contact form by submitting inquiry
...
- [ ] Begin content marketing (blog posts if in scope)
- [ ] Set up Google Ads or Meta Ads campaigns
...
- [ ] A/B test CTA button copy or placement
